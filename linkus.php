...
elseif($action=="edit") {
	...
	if(mysql_num_rows($ergebnis)) {
		...
		while($ds=mysql_fetch_array($ergebnis)) {
			...
			$adminaction='';
			if(ispageadmin($userID))
			$adminaction='<br /><input type="button" onclick="MM_goToURL(\'parent\',\'index.php?site=linkus&amp;action=edit&amp;bannerID='.$ds['bannerID'].'\');return document.MM_returnValue" value="'.$_language->module['edit'].'" />
