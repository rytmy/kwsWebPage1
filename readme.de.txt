...
Vielen Dank, dass du dich für die webSPELL Society Edition entschieden hast.
...
2. Installation
	...
	3. Die richtigen Datei- und Ordnerrechte setzen
		...
		webSPELL benötigt spezielle Zugriffsrechte für einige Dateien und Ordner. Der Installationsprozess in Punkt 4. versucht diese automatisch zu setzen. Sollte dies scheitern, informiert dich der Intallationsprozess darüber und die Rechte müssen wie folgt beschrieben manuell vergeben werden.
		
		Diese Rechte können mit dem FTP-Programm vergeben werden. Um dies umzusetzen, klicke in dem FTP-Programm rechts auf die gewünschten Dateien und Ordner und suche nach etwas namens "Eigenschaften", "chmod", "Properties" etc. (die bezeichnung variiert von FTP-Programm zu FTP-Programm). Folgende Dateien und Ordner nun auf chmod 777 setzen:
