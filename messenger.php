    ...
    $anz=mysql_num_rows($ergebnis);
      ...
      $n=1;
			while($ds=mysql_fetch_array($ergebnis)) {
				...
				if(isclanmember($ds['fromuser'])) $member=' <img src="images/icons/member.gif" width="6" height="11" alt="Member" />';
				else $member='';
    ...
    echo $pm_outgoing_head;
      ...
      $n=1;
			while($ds=mysql_fetch_array($ergebnis)) {
				...
				if(isclanmember($ds['touser'])) $member=' <img src="images/icons/member.gif" width="6" height="11" alt="Member" />';
				else $member='';
