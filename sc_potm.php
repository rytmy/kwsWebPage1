...
if($randomid) echo '<center><a href="index.php?site=gallery&amp;picID='.$randomid.'"><img src="images/gallery/thumb/'.$randomid.'.jpg" border="0" alt="'.$_language->module['random_picture'].'" /></a></center>';
?>
