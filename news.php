...
elseif($action=="unpublished") {
  ...
  eval ("\$title_news = \"".gettemplate("title_news")."\";");
	...
	echo $post.' <input type="button" onclick="MM_goToURL(\'parent\',\'index.php?site=news\');return document.MM_returnValue;" value="'.$_language->module['show_news'].'" /><br /><br />';
...
elseif($action=="archive") {
	...
	eval ("\$title_newsarchive = \"".gettemplate("title_newsarchive")."\";");
	echo $title_newsarchive;
